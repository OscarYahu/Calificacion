...
public class MainClass {
    ...
    private static void relacionarCitaDoctorPaciente() {
        ...
        if (doctor != null && paciente != null && cita != null) {
            ...
            System.out.println("La cita ha sido relacionada con el doctor y paciente exitosamente.");
        } else {
            System.out.println("No se encontró la cita, el doctor o el paciente. Verifique los identificadores.");
        }
